...
MemoWriterAgent = rt.agent_node(
    ...
    system_message=(
        ...
        "Explain trade-offs in plain language for non-technical readers. "
        "Keep language clear for both residents and councillors. "
        "In recommendation_section include two labeled subsections: "
        "'For citizens:' and 'For councillors:'. "
